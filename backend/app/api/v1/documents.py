...
@router.get(
    ...
    description="Fetches paginated list of documents uploaded by the authenticated user.",
)
async def list_documents(
    ...
    docs = await DocumentRepository.get_all_by_user(db, user_id=current_user.id, limit=limit, offset=offset)
    return [
        DocumentResponse(
            document_id=d.id,
            filename=d.filename,
            ...
            successful_records=d.successful_records,
            failed_records=d.failed_records,
